<?php
include 'databaseclass.php'; //bewerkingen uitvoeren (CRUD)
...
if($Qres)
{
    echo 'Film is succesvol gewijzigd! Zie <a href="index.php?page=movieswatched">MoviesWatched</a>!!<br />';
    echo 'Of ga terug naar de lijst met nog te bekijken <a href="index.php?page=watchlist">ga terug</a>';
}else
{
